...
def main():
	...
	RSS.setPatterns(["Gamma-ray", "gamma-ray", "Gamma-Ray", "Gamma Ray", "gamma ray", "Gamma ray", "gamma Ray"])
	...
	RSSWebpage.buildPage("newfeeds_grb.html")

	savename = "arxiv_feed_%s_%s.rss" % ("grb", RSS._date)
